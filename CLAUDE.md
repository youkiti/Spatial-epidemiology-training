...
**Phase0〜Phase3 が完了し、GitHub Pages で公開されている（2026-08-21時点）。** 設計文書・サイト骨格・クイズエンジン・概念パート全6章・Phase1のデータ整備・引用の一次資料での裏取り・Rハンズオン本編3本が main に入っている。**ただし「open issue は残っていない」わけではない** — 同日の納品前監査で issue #44〜#55 の12件が新規に起票され、2026-08-22時点で #54（監修体制の記録）を残すのみとなっている。
