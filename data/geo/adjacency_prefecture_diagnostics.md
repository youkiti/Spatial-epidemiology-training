...
- 連結成分の個数: 4
- サイズ(降順)と地方内訳:
  - 成分1: 38都道府県(東北6・関東7・中部9・近畿7・中国5・四国4)
  - 成分2: 7都道府県(九州7)
  - 成分3: 1都道府県(孤立: 北海道)
  - 成分4: 1都道府県(孤立: 沖縄県)
...
- 地方をまたぐブリッジ(除去すると連結成分の数が増えるエッジ)を機械的に
  列挙する。地方境界をまたぐエッジは陸続きの地方間(東北-関東など)にも
  多数あるが、そのほとんどはブリッジではない(迂回路が別にある)。
  ブリッジかつ地方をまたぐものだけに絞ると、「その1本だけで地方間の
  連結・非連結が決まる」急所だけが残る。
  - ブリッジ総数: 3 件(無向グラフとして判定)
  - うち地方をまたぐもの: 1 件
  - 地方をまたぐブリッジの一覧:
    - 岡山県(33、中国) <-> 香川県(37、四国)
  都道府県をまたぐブリッジは、その1本で地方間の連結・非連結が決まって
  いる急所である。具体的な地名の由来・妥当性の解説は data/geo/README.md
  を参照。
