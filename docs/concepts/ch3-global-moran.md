...
<figure>
<svg viewBox="0 0 220 180" style="max-width:100%;height:auto" role="img">
...
<figure>
<svg viewBox="0 0 240 240" style="max-width:100%;height:auto" role="img">
...
Pradhan P, Iyer HS, Rebbeck TR. *JAMA Netw Open.* 2025;8:e2537905(がん検診)は、米国の county 単位のがん検診率を対象に、次の手順で分析しています。
...
この論文は、Global(全体として偏っているか)から Local(具体的にどこか)へと進む手順が明確な実例です。ここでは手順の並び順のみを紹介し、Moran's I の具体的な数値には触れません(原著での裏取りが済んでいないため)。手順の続き(LISA による具体的なクラスターの特定)は次章で扱います。
