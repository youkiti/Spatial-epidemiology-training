...
地域どうしで割合を比べるとき、もう1つ注意が必要なのが年齢構成です。多くの疾患は高齢者ほど頻度が高いため、高齢者の割合が高い地域は、それだけで粗割合(年齢調整をしない割合)が見かけ上高くなります。したがって年齢構成が地域間で大きく異なる場合は、年齢構成をそろえた**年齢標準化**で比較します。直接法・間接法という2通りの標準化の方法があること自体は、疫学の基礎科目で扱われる範囲なのでここでは深入りしません。空間疫学として重要なのは、**地図に塗る数値をどちらで作るか(粗割合か標準化割合か)によって、地図の見え方が変わりうる**という点です。
